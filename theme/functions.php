...
function get_title($title) {
  global $branax;
  return $title . (isset($branax['title_append']) ? $branax['title_append'] : null);
}
    ...
    $createMenu = function ($items, $callback) use (&$createMenu, $createUrl) {
        ...
        foreach ($items as $item) {
            ...
            if (isset($item['submenu'])) {
                list($submenu, $selectedParent) = $createMenu($item['submenu']['items'], isset($item['submenu']['callback']) ? $item['submenu']['callback'] : $callback);
